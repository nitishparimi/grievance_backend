...
public class StudentController {
	...
	public ResponseEntity<ApiResponse<List<GrievanceEntity>>> getUserGrievance(@RequestParam("id") String id){
		List<GrievanceEntity> grievances = grievanceServ.findGrievanceByUser(id);
		return ResponseEntity.ok(new ApiResponse<>("success", "User Grievances", grievances));
	}
}
